...
path =r'\\equipe2-nas1\F.LARENO-FACCINI\BACKUP FEDE\Ephy\Group 15\173 (CM16-Buz - Female)\Experiment\Fixed Delay\P0\tdc_173_EF_P0'
...
for chan_grp in channel_groups:
    ...
    for cluster in pos_clustlist:
        ...
        for i in range(16):
            ax2.plot(np.arange(0,16,1),waveforms[cluster+delta].min(axis=0))
